...
const  UserAuthentication = () => {
  return (
    <div className="flex justify-center items-center min-h-screen bg-gray-900 text-black">
      <div className="text-center p-8 bg-white shadow-lg rounded-lg w-80">
        <h2 className="text-2xl font-bold mb-4 text-black">Welcome to Book Store</h2>
        <p className="mb-4">Please choose an option to proceed:</p>
