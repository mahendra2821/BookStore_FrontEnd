...
const AdminAuth = () => {
  ...
  return (
    <div className="flex justify-center items-center min-h-screen bg-gradient-to-br bg-black text-white">
      <div className="p-8 border border-gray-700 rounded-lg shadow-lg w-96 bg-gray-900">
